...
function shopReagents(req, res, next) {
    res.status(200).jsonp({
        ...
        success: true,
        items: {
            133588 : { id : 133588, name : "Flaked Sea Salt", cost : 0.5 },
            133589 : { id : 133589, name : "Dalapeño Pepper", cost : 0.5 },
            133590 : { id : 133590, name : "Muskenbutter", cost : 0.5 },
            133591 : { id : 133591, name : "River Onion", cost : 0.5 },
            133592 : { id : 133592, name : "Stonedark Snail", cost : 0.5 },
            133593 : { id : 133593, name : "Royal Olive", cost : 0.5 }
        }
    });
}
